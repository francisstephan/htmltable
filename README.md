...
fn main() {
    let args = Args::parse();
```
Within the `Args` struct, the `ìnput` item for instance is a rust variable of type String, and is also the name of the corresponding argument in the argument list.
